var bar_test_app = angular.module("bar_test_app",[]);

bar_test_app.controller("bar_test_controller",['service_socket','$scope', function(Service_socket, $scope){
	...
	$scope.currentGroup = $scope.groupItems[2];
}]);

bar_test_app.service("service_socket", function(){
